...
<br><br>
	<p style="font-family: 'NIXGONB-Vb';color: black;">
	탈퇴 안내<br><br>
	회원탈퇴를 신청하기 전에 안내 사항을 꼭 확인해주세요.<br>
	<br>
	사용하고 계신 계정은 탈퇴할 경우 재사용 및 복구가 불가능합니다.<br>
	탈퇴한 아이디는 본인과 타인 모두 재사용 및 복구가 불가하오니 <br>
	신중하게 선택하시기 바랍니다.<br>
	<br>
	...
	<h4 style="font-family: 'NIXGONB-Vb';color: #bbbfbf;">회원탈퇴를 진행합니다.</h4>
	<br>
	<h5 style="font-family: 'NIXGONB-Vb'; color: #bbbfbf;">비밀번호를 입력해 주세요</h5>
<div id = "div_currpw">
...
<div id = "btns" class="text-center">
         <button type="submit" id="btnCancel" class="btn btn-danger"
         style="font-family: 'NIXGONB-Vb';">취소</button>
         <button type="submit" id="btnOut" class="btn btn-warning"
